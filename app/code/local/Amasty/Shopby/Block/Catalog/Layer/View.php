...
class Amasty_Shopby_Block_Catalog_Layer_View extends Amasty_Shopby_Block_Catalog_Layer_View_Pure
{
    ...
    public function getFilters()
    {
        ...
        $f = $this->getChild('new_filter');
        if ($f instanceof Amasty_Shopby_Block_Catalog_Layer_Filter_New
        ...
        foreach ($filters as $f){
            ...
            if ($f instanceof Amasty_Shopby_Block_Catalog_Layer_Filter_New) {
                $f->setPosition($filtersPositions['ama_new_filter']);
            }
            if ($f instanceof Amasty_Shopby_Block_Catalog_Layer_Filter_Stock) {
    ...
    protected function _afterToHtml($html)
    {
        ...
        if (!$html) {
            ...
            if ($queldorei_blocks && !empty($queldorei_blocks['block_layered_nav'])) {
        ...
        $enableOverflowScroll = Mage::getStoreConfig('amshopby/general/enable_overflow_scroll');
...
div.amshopby-overflow-scroll-enabled div.block-content dl dd > ol:first-of-type {
    max-height: {$enableOverflowScroll}px; overflow-y: auto;
}
</style>";
            }
        }
