...
<div class="container_12">
	<div class="grid_12 subtitle">
		<span>Update CPMagento Importer</span>
	</div>
</div>
<div class="container_12">
<?php if (false) {
...
<form method="post" enctype="multipart/form-data"
		...
		<div class="grid_12 col">
			<h3>Update CPMagento Importer</h3>
...
<?php 
    ...
    ?>
<div class="grid_12 col">
		<h3>Automatic Updates Disabled</h3>
		<div class="error">Upgrades of the CPMagento Importer are Performed Manually</div>
	</div>
<?php 
}?>
</div>
<div class="container_12">
	<div class="grid_12 subtitle">
		<span>Run CPMagento Importer</span>
<?php if (!$conf_ok) {
    ?>
...
<form method="POST" id="runmagmi"
	...
	<div class="container_12">
		<div class="grid_12 col" id="directrun">
			<h3>Directly run CPMagento Importer with existing profile</h3>
			<div class="formline">
				<span class="label">Run CPMagento Importer With Profile:</span>
